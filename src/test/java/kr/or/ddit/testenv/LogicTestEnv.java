...
import kr.or.ddit.config.spring.ApplicationDatasourceDev;
...
@ContextConfiguration(classes = {RootContext.class, ApplicationDatasourceDev.class, ApplicationTransaction.class})
